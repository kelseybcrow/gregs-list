...
let _state = {
  ...
  houses: [
    new House({ price: 300000, bedrooms: 3, bathrooms: 2.5, img: "//placehold.it/200x200/", description: "lorem ipsum dolor" }),
    new House({ price: 400000, bedrooms: 4, bathrooms: 3, img: "//placehold.it/200x200/", description: "lorem ipsum dolor" }),
    new House({ price: 500000, bedrooms: 4, bathrooms: 4, img: "//placehold.it/200x200/", description: "lorem ipsum dolor" })
  ]
};
